...
[T_order, T] = uribe_fixed_24_irf.static_resid_tt(y, x, params, T_order, T);
residual = NaN(24, 1);
    residual(1) = (y(7)) - (T(2)*T(3));
    residual(2) = (y(8)) - ((y(5)-exp((-y(21)))*params(2)*y(13))*params(4)*exp(y(19))/(1-exp(y(19))*y(6)));
    residual(3) = (y(7)) - (T(4)*exp((-y(24))-params(3)*y(21)));
    residual(4) = (y(5)) - (T(5));
    residual(5) = (y(8)) - (T(6)/y(9));
residual(6) = y(5)*(-params(6))*T(7)-T(8)*T(9)+T(9)*T(10);
    residual(7) = (1+y(11)) - (exp(y(22))*T(11)*T(15));
