...
residual = NaN(24, 1);
    residual(1) = (y(31)) - (T(1)*T(12));
    residual(2) = (y(32)) - (params(4)*exp(y(43))*(y(29)-exp((-y(45)))*params(2)*y(13))/(1-exp(y(43))*y(30)));
    residual(3) = (y(31)) - (params(1)*(1+y(35))*y(55)/(1+y(60))*exp((-(params(3)*y(69)))));
    residual(4) = (y(29)) - (T(2));
    residual(5) = (y(32)) - (T(3)/y(33));
residual(6) = y(29)*(-params(6))*T(4)-T(5)*T(6)+T(8)*T(9);
    residual(7) = ((1+y(35))/exp(y(47))) - (exp(y(46))*T(13)*T(18));
    residual(8) = (y(28)) - ((1+y(36))/(1+y(16)));
    residual(9) = (y(27)) - ((1+y(35))/(1+y(17)));
...
residual(15) = y(48);
    ...
    residual(20) = (1+y(34)) - (T(11)*T(14));
    residual(21) = (y(39)) - (y(34));
    residual(22) = (y(26)) - ((1+y(35))/(1+y(36)));
    residual(23) = (y(47)) - (0.999*y(23)+params(29)/100*x(6));
    residual(24) = (y(38)) - (y(47));
end
