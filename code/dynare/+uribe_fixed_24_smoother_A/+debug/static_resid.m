...
lhs(3) = y(7);
rhs(3) = T(5)*exp((-y(24))-params(3)*y(21));
lhs(4) = y(5);
rhs(4) = T(6);
lhs(5) = y(8);
rhs(5) = T(7)/y(9);
lhs(6) = y(5)*(-params(6))*T(8)-T(9)*T(10)+T(10)*T(11);
rhs(6) = 0;
lhs(7) = 1+y(11);
rhs(7) = exp(y(22))*T(12)*T(16);
lhs(8) = y(4);
...
rhs(24) = 0;
lhs(25) = y(25);
rhs(25) = 100*log(y(1)/exp(params(12)));
lhs(26) = y(26);
rhs(26) = 100*log(y(2)/T(1));
lhs(27) = y(27);
rhs(27) = 100*log(y(3));
lhs(28) = y(28);
rhs(28) = 100*log(y(4));
